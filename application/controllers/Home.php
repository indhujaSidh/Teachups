...
class Home extends CI_Controller
{
    ...
    public function forum()
    {
        ...
        $page_data['page_title'] = site_phrase('forum');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    public function contactus()
    {
        $page_data['page_name'] = 'contactus';
        $page_data['page_title'] = site_phrase('contactus');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    public function kidslearningzone()
    {
        $page_data['page_name'] = 'kidslearningzone';
        $page_data['page_title'] = site_phrase('kidslearningzone');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }

    public function kidsvideo()
    {
        $page_data['page_name'] = 'kidsvideo';
        $page_data['page_title'] = site_phrase('kidsvideo');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }



    public function alphabeticallearning()
    {
        $page_data['page_name'] = 'alphabeticallearning';
        $page_data['page_title'] = site_phrase('alphabeticallearning');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    public function science_forum()
    {
        $page_data['page_name'] = 'science_forum';
        $page_data['page_title'] = site_phrase('science_forum');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    public function quiz()
    {
        $page_data['page_name'] = 'quiz';
        $page_data['page_title'] = site_phrase('quiz');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    public function mathsquiz1()
    {
        $page_data['page_name'] = 'mathsquiz1';
        $page_data['page_title'] = site_phrase('mathsquiz1');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
    public function kidspuzzle()
    {
        $page_data['page_name'] = 'kidspuzzle';
        $page_data['page_title'] = site_phrase('kidspuzzle');
        $this->load->view('frontend/' . get_frontend_settings('theme') . '/index', $page_data);
    }
